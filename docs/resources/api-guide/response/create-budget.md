...
|Status|The status of the BudgetAddRq|
...
|5010|Error|Validation failure|No such categoryId is found||
|5020|Error|Validation failure|No such subcategoryId is found for this category||
...
|5070|Error|Validation failure|Budget already exists for this Category and SubCategory||
